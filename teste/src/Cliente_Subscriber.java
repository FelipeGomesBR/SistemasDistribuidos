...
public class Cliente_Subscriber {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cliente_Subscriber window = new Cliente_Subscriber();
	...
	private void initialize() {
		...
		lblInscreverse.setFont(new Font("Calibri Light", Font.PLAIN, 20));
